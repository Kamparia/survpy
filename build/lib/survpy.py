...
#Description: SurvPy is a Python based
#module developed by Geospatech NG to
#enable the community of Python users to
#be able to execute land surveying related
#computations using a set of properly
#defined functions.
...
def plots(area_sqmts,stnd_lenght,stnd_breadth):
    a = stnd_lenght * stnd_breadth
    plot = area_sqmts / a
    plots = round(plot,0)
    print("There exist approximately",plots,"plots in",area_sqmts,"sq.mts")
